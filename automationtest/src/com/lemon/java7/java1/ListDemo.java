 ...
 */
    ...
    public void test4(){
        ...
        //boolean containsKey(Object key):是否包含指定的key
        boolean is = map.containsKey("ff");
        System.out.println(is);
        //boolean containsValue(Object value):是否包含指定的value
        boolean if1 = map.containsValue(null);
    ...
    void clear():清空当前map中所有数据
        ...
        map.putAll(map1);
        System.out.println(map);
        Object st = map.remove("cc",123);
        System.out.println(st);
        System.out.println(map);
        Map mapq = new HashMap();
        mapq.put(null,null);
        Map mapqq = new HashMap();
        mapqq.put("ss",null);
        System.out.println(mapq.equals(mapqq));
    }
